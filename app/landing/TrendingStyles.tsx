    ...
    <section className="relative overflow-hidden py-24">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          {/* Cyberpunk Card */}
          <div className="group relative rounded-3xl overflow-hidden cursor-pointer h-[500px] transition-all duration-500 hover:shadow-[0_0_30px_rgba(92,225,230,0.2)] border border-white/5">
            <img
          ...
          <div className="group relative rounded-3xl overflow-hidden cursor-pointer h-[600px] md:-mt-12 transition-all duration-500 hover:shadow-[0_0_40px_rgba(255,49,49,0.2)] border-2 border-transparent hover:border-secondary/30 z-20">
            <img
